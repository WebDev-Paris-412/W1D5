...
function createSequence(number) {
	...
	console.log(returnedArray, number)
	return returnedArray
}
...
function multiplyBy(arrayOfNumbers, multiplier) {
	...
	arrayOfNumbers.forEach(function (element) {
		console.log(element)
		const result = element * multiplier
	...
	// }
	// console.log(arrayOfNumbers, resultArray, multiplier)
	return resultArray
}
...
function filterOut(originalArray, wordsToRemove) {
	...
	const finalArray = []
	for (const word of originalArray) {
		console.log(word, wordsToRemove)
		if (!wordsToRemove.includes(word)) {
		}
		// if (!wordsToRemove.includes(originalWord)) {
